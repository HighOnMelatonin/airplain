...
if submit:
    if pop_density and zero_to_ten_proximity and ten_to_twenty_proximity and twenty_to_fifty_proximity and public_transport:
        try:
            ...
            if np.isclose(zero_to_ten_proximity + ten_to_twenty_proximity + twenty_to_fifty_proximity,1.0):
                result = predict_value(zero_to_ten_proximity, ten_to_twenty_proximity, twenty_to_fifty_proximity, pop_density, public_transport)
                st.write("Predicted Result is:", result)
